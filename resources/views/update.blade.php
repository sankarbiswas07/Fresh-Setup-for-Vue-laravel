...
@section('content')
        ...
        <div class="container" style="margin-top: 13vh">
            <div class="row tab">
                <div class="col-xs-offset-2" >
                    ...
                    <div class="col-xs-1">
                        <button class="btn btn-default tablinks"  onclick="updateResult(event,'first',id)" id="t1" style="background-color:#399cf9"></button>
                    </div>
                    ...
                    <div class="col-xs-1">
                        <button class="btn btn-default tablinks" onclick="updateResult(event,'second',id)" id="t2"></button>
                    </div>
                    <div class="col-xs-3" style="margin-top: -5px">
                        <hr style="height:2px; background-color: black;"/>
                    ...
                    <div class="col-xs-1">
                        <button class="btn btn-default tablinks"  onclick="updateResult(event,'third',id)" id="t3"></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form method="post" action="{{route('update')}}">
                ...
                <div class="row" style="margin-top:4.5vh">
                    <div class="col-lg-4 col-lg-offset-1">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" name="t_name" id="t_name" placeholder="Train Name" value="{{ $train->t_name }}" />
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-minus-square fa-fw"></i></span>
                            <input class="form-control" type="text" name="t_no" id="t_no" placeholder="Train Number"  value="{{ $train->t_no }}" />
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="input-group">
        ...
        <section id="third" style="display:none" class="tabcontent">
            ...
            <center>
                <button id="t3btn" class="btn btn-default" style="background-color:#399cf9; color:white;margin-left:-20px;margin-top:30.5vh" type="submit" >Submit</button>
            </center>
        </section>
    </form>
    <!--
